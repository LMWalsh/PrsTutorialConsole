...
namespace PrsTutorialLibrary {

    public class AppDbContext : DbContext {

        public virtual DbSet<User> Users { get; set; }
        public virtual DbSet<Vendor> Vendors { get; set; }  // same type for vendors
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder builder) {
            if (!builder.IsConfigured) {
                ...
                var connStr = @"server=localhost\sqlexpress;database=PrsTutorialDb;trusted_connection=true;";
        ...
        protected override void OnModelCreating(ModelBuilder builder) {
            builder.Entity<User>(e => {
                e.ToTable("Users"); // plural version of class name
            ...
            builder.Entity<Vendor>(e => {   // builder.entity<vendor
                e.ToTable("Vendors"); //plural version of class name
                e.HasKey(x => x.Id); //primary key
