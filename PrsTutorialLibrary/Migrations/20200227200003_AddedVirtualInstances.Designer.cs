...
namespace PrsTutorialLibrary.Migrations
{
    ...
    [Migration("20200227200003_AddedVirtualInstances")]
    partial class AddedVirtualInstances
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrsTutorialLibrary.Models.Product", b =>
                {
                    b.HasOne("PrsTutorialLibrary.Models.Vendor", "Vendor")
                        .WithMany()
            ...
            modelBuilder.Entity("PrsTutorialLibrary.Models.RequestLine", b =>
                {
                    b.HasOne("PrsTutorialLibrary.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PrsTutorialLibrary.Models.User", "User")
                        .WithMany()
